...
from XSUI.webapp.dash.models import db
from typing import List

class DetectorMask(db.Model):
    """
...
class CompositeMask(db.Model):
    ...
    id = sa.Column(sa.Integer, primary_key=True)
    detector_mask : orm.Mapped[int] = orm.mapped_column(sa.ForeignKey("detector_masks.id"))
    custom_masks: orm.Mapped[List[int]] = orm.relationship("CustomMask")
